...
@Query("Select new com.surrogate.numy.models.DTO.MensajeDTO(m.id_mensaje, m.id_chat.id_chat, m.id_chat.nombreChat, m.contenido, m.emisor.nombre, m.receptor.nombre) from Mensaje m where m.id_chat.id_chat= :idChat order by m.fechaHora asc")
