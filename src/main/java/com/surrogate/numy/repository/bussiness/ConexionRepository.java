...
public interface ConexionRepository extends JpaRepository<Conexion, Long> {
    ...
    @Query("Select new com.surrogate.numy.models.DTO.ConexionDTO(c.id_conexion, c.id_usuario1.nombre, c.id_usuario2.nombre) from Conexion c where c.id_usuario1.nombre= :nombreUsuario")
