 ...
 * @author Rob Winch
 */
public class DaoAuthenticationProviderWithId extends AbstractUserDetailsAuthenticationProviderWithId {
    ...
    private UserDetailsPasswordServiceId userDetailsPasswordService;

    public DaoAuthenticationProviderWithId() {
     ...
     * @since 6.0.3
     */
    public DaoAuthenticationProviderWithId(PasswordEncoder passwordEncoder) {
    ...
    @Override
    protected final UserDetailsWithId retrieveUser(String username, UsernamePasswordAuthenticationToken authentication)
            throws AuthenticationException {
        prepareTimingAttackProtection();
        try {
            UserDetailsWithId loadedUser = this.getUserDetailsService().loadUserByUsername(username);
            if (loadedUser == null) {
